...
class TestUserService:
    ...
    @pytest.mark.asyncio
    async def test_get_by_id_returns_user(self, user_service, mock_user_repository, sample_uuid):
    ...
    @pytest.mark.asyncio
    async def test_get_by_id_returns_none_when_user_not_found(self, user_service, mock_user_repository, sample_uuid):
    ...
    @pytest.mark.asyncio
    async def test_get_by_filter_returns_users_and_count(self, user_service, mock_user_repository):
        ...
        mock_user_repository.get_by_filter.return_value = (expected_users, expected_total_count)
    ...
    @pytest.mark.asyncio
    async def test_update_returns_updated_user(self, user_service, mock_user_repository, sample_uuid):
    ...
    @pytest.mark.asyncio
    async def test_delete_calls_repository_delete(self, user_service, mock_user_repository, sample_uuid):
