...
class TestProductService:
    ...
    @pytest.mark.asyncio
    async def test_get_by_id_returns_product(self, product_service, mock_product_repository, sample_uuid):
    ...
    @pytest.mark.asyncio
    async def test_get_all_returns_products_list(self, product_service, mock_product_repository):
    ...
    @pytest.mark.asyncio
    async def test_create_returns_new_product(self, product_service, mock_product_repository):
    ...
    @pytest.mark.asyncio
    async def test_update_returns_updated_product(self, product_service, mock_product_repository, sample_uuid):
        ...
        assert result == expected_product
        mock_product_repository.update.assert_called_once_with(sample_uuid, product_data)

    @pytest.mark.asyncio
    async def test_delete_calls_repository_delete(self, product_service, mock_product_repository, sample_uuid):
    ...
    async def test_repository_methods_called_with_correct_arguments(
        ...
        mock_product_repository.update.assert_called_with(sample_uuid, product_update_data)
