...
class TestOrderService:
    ...
    @pytest.mark.asyncio
    async def test_get_by_id_returns_order(self, order_service, mock_order_repository, sample_uuid):
    ...
    @pytest.mark.asyncio
    async def test_get_all_returns_orders_list(self, order_service, mock_order_repository):
    ...
    @pytest.mark.asyncio
    async def test_get_by_user_returns_orders_list(self, order_service, mock_order_repository, sample_uuid):
    ...
    @pytest.mark.asyncio
    async def test_delete_calls_repository_delete(self, order_service, mock_order_repository, sample_uuid):
